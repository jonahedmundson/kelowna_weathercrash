...
cat('-----------------\nTop 5 Most Common Crash Types:')
table(cyclist$Derived.Crash.Configuration)[order(table(cyclist$Derived.Crash.Configuration), decreasing = TRUE)][1:5]
rm(cyclist)
@
...
cat('-----------------\nTop 5 Most Common Crash Types:')
table(animal$Derived.Crash.Configuration)[order(table(animal$Derived.Crash.Configuration), decreasing = TRUE)][1:5]
rm(animal)
@
...
cat('-----------------\nTop 5 Most Common Crash Types:')
table(heavy$Derived.Crash.Configuration)[order(table(heavy$Derived.Crash.Configuration), decreasing = TRUE)][1:5]
rm(heavy)
@
...
cat('-----------------\nTop 5 Most Common Crash Types:')
table(motorcycle$Derived.Crash.Configuration)[order(table(motorcycle$Derived.Crash.Configuration), decreasing = TRUE)][1:5]
rm(motorcycle)
@
...
cat('-----------------\nTop 5 Most Common Crash Types:')
table(parked$Derived.Crash.Configuration)[order(table(parked$Derived.Crash.Configuration), decreasing = TRUE)][1:5]
rm(parked)
@
...
cat('-----------------\nTop 5 Most Common Crash Types:')
table(pedestrian$Derived.Crash.Configuration)[order(table(pedestrian$Derived.Crash.Configuration), decreasing = TRUE)][1:5]
rm(pedestrian)
@
...
cat('Variables:')
names(regdata)
pairs(regdata[,c('crashes','month', 'day','temp','relhum','precip','visibility')], upper.panel = function(x,y) panel.smooth(x,y,lwd=2,span=0.8))
@
