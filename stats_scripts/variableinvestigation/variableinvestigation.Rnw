...
print('Rounded table of precipitation values:')
...
weatherdata %>%
  ...
  ylab('Precipitation (avg. per 3 hr block)') + 
  xlab('') +
...
print('Very little differences in visibility...')
print('Density plot isn\'t helpful because cases are so spread out.')
@
