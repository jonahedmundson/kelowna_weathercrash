...
head(test, 10)
#c('Temp.Flag', 'Dew.Point.Temp.Flag', 'Rel.Hum.Flag', 'Precip..Amount..mm.', 'Precip..Amount.Flag', 'Wind.Dir.Flag', 'Wind.Spd.Flag', 'Visibility.Flag', 'Stn.Press.Flag', 'Hmdx', 'Hmdx.Flag', 'Wind.Chill.Flag')
